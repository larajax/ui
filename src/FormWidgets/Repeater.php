...
class Repeater extends FormWidgetBase
{
    ...
    use \Larajax\Ui\FormWidgets\Repeater\HasJsonStore;
    use \Larajax\Ui\FormWidgets\Repeater\HasRelationStore;
    ...
    protected function processLoadedState()
    {
        ...
        // Normalize a null postback value so the cleared state loads as empty
     ...
     * @return \Larajax\Ui\Widgets\Form
     */
